        ...
        <section className="w-full xl:py-24 lg:py-20 py-12 ">
          <div className="w-full max-w-7xl px-6 lg:px-8 mx-auto">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
              <div>
                <h1 className="font-manrope text-primary md:text-5xl text-4xl font-bold leading-tight mb-8 lg:text-left text-center">
                  Contact Us
                </h1>
                ...
                <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-primary/80">
                    <a
                      href="javascript:;"
                      className="w-14 h-14 bg-primary/80 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                    >
                      <svg
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                      Contact us at any time, we are ready to help you.
                    </p>
                    <p className="group-hover:text-white mt-2 text-gray-700 text-sm">
                      Phone: +1 (313) 960-3654
                    </p>
                    <p className="group-hover:text-white mt-2 text-gray-700 text-xs">
                      Email: service@auraproperties.us
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-primary/80">
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                      Visit our office or send us a letter.
                    </p>
                    <p className="group-hover:text-white mt-2 text-gray-700 text-sm">
                      Address: Hilliard OH
                    </p>
              ...
              >
                ...
                <button className="w-full h-12 rounded-full bg-primary transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                  Send message{" "}
                  <svg
                    width="20"
                    height="20"
